...
ActiveRecord::Schema.define(version: 20160131182123) do
  ...
  add_index "jogadors", ["reset_password_token"], name: "index_jogadors_on_reset_password_token", unique: true, using: :btree
